...
const FinishedState = () => {
  ...
  const { getCurrentUserDetails } = useContext(WeitterContext);
  ...
  return (
    <div className={style.wrapper}>
      ...
      <img
        src="https://raw.githubusercontent.com/CleverProgrammers/twitter-blockchain-youtube/main/client/assets/check.png"
        alt="checkmark"
        height={100}
        width={100}
      />
